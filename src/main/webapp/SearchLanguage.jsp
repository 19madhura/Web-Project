...
<div class="container">
<h1 class="display-4" style="color:white;font-weight: 500;font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif">Search Books Of Different Languages</h1>
<hr>
...
<br>
<a href="SearchBook.jsp" style="padding-left:12%" ><button type="button" class="btn btn-light" >Back</button></a>
